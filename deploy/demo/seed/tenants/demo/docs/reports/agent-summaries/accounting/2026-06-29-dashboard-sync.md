# accounting Agent 要約 2026-06-29
...
| パス | 状態 |
|------|------|
| `data/finance/invoices/` | missing |
| `docs/finance/accounting/` | missing |
...
orgos route match --text "（accounting 担当）"
```

## 根拠

- [accounting_agent.md](../../../steward/core/agents/accounting_agent.md)
- [agent-capability-manifest.yaml](../../../steward/core/agents/agent-capability-manifest.yaml)

*生成: orgos agent pulse · 2026-06-28T22:18:33.410Z*