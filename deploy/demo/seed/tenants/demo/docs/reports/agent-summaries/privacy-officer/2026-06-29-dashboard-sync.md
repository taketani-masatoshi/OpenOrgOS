# privacy_officer Agent 要約 2026-06-29
...
orgos route match --text "（privacy_officer 担当）"
```

## 根拠

- [privacy_officer_agent.md](../../../steward/core/agents/privacy_officer_agent.md)
- [agent-capability-manifest.yaml](../../../steward/core/agents/agent-capability-manifest.yaml)

*生成: orgos agent pulse · 2026-06-28T22:18:33.539Z*