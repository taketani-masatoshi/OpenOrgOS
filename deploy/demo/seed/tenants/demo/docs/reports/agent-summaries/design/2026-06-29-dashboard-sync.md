...
orgos route match --text "（design 担当）"
```

## 根拠

- [design_agent.md](../../../steward/core/agents/design_agent.md)
- [agent-capability-manifest.yaml](../../../steward/core/agents/agent-capability-manifest.yaml)

*生成: orgos agent pulse · 2026-06-28T22:18:33.333Z*