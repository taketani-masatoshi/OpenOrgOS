...
- **REG-001** 役員報酬規程 — 施行: `docs/company/regulations/yakuin-hoshu-kisoku.md` · テンプレ: `steward/standards/regulations/core/REG-001-yakuin-hoshu/template.md`
- **REG-002** 取締役会議事規則 — 施行: `docs/company/regulations/torishimari-kai-gijisho-kisoku.md` · テンプレ: `steward/standards/regulations/core/REG-002-torishimari-kai/template.md`
- **REG-003** 株主総会議事規則 — 施行: `docs/company/regulations/shukai-gijisho-kisoku.md` · テンプレ: `steward/standards/regulations/core/REG-003-shukai-gijisho/template.md`
- **REG-004** 稟議・決裁規程 — 施行: `docs/company/regulations/ringi-kessai-kisoku.md` · テンプレ: `steward/standards/regulations/core/REG-004-ringi-kessai/template.md`
- **REG-005** 経費精算規程 — 施行: `docs/company/regulations/keihi-seisan-kisoku.md` · テンプレ: `steward/standards/regulations/core/REG-005-keihi-seisan/template.md`
- **REG-006** 利益相反取引規程 — 施行: `docs/company/regulations/riekisohan-torihiki-kisoku.md` · テンプレ: `steward/standards/regulations/core/REG-006-riekisohan/template.md`
- **REG-007** 文書管理規程 — 施行: `docs/company/regulations/bunsho-kanri-kisoku.md` · テンプレ: `steward/standards/regulations/core/REG-007-bunsho-kanri/template.md`
- **REG-008** 旅費規程 — 施行: `docs/company/regulations/ryohi-kisoku.md` · テンプレ: `steward/standards/regulations/core/REG-008-ryohi/template.md`
- **REG-009** 情報セキュリティ管理規程 — 施行: `docs/company/regulations/joho-security-kanri-kisoku.md` · テンプレ: `steward/standards/regulations/core/REG-009-joho-security/template.md`
- **REG-010** 個人情報保護規程 — 施行: `docs/company/regulations/kojin-joho-hogo-kisoku.md` · テンプレ: `steward/standards/regulations/core/REG-010-kojin-joho/template.md`
- **REG-011** 品質管理規程 — 施行: `docs/company/regulations/hinshitsu-kanri-kisoku.md` · テンプレ: `steward/standards/regulations/core/REG-011-hinshitsu/template.md`
- **REG-014** 環境・エネルギー管理規程 — 施行: `docs/company/regulations/kankyo-energy-kanri-kisoku.md` · テンプレ: `steward/standards/regulations/core/REG-014-kankyo-energy/template.md`
- **REG-016** 内部監査規程 — 施行: `docs/company/regulations/naibu-kansa-kisoku.md` · テンプレ: `steward/standards/regulations/core/REG-016-naibu-kansa/template.md`
- **REG-012** 宿泊運営・サステナビリティ規程 — 施行: `docs/company/regulations/shukuhaku-unyo-kisoku.md` · テンプレ: `steward/standards/regulations/by-module/hospitality/REG-012-shukuhaku-unyo/template.md`
