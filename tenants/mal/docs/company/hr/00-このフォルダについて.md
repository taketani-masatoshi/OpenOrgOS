...
正データ（非個情）: [`data/hr/employees.yaml`](../../../data/hr/employees.yaml)
...
記入済みファイルは **Git 非追跡**。  
[`records/00-このフォルダについて.md`](records/00-このフォルダについて.md) 参照。

---

## 関連

- [REG-015 安全衛生管理規程](../regulations/anzen-eisei-kanri-kisoku.md)
- [REG-010 個人情報保護](../regulations/kojin-joho-hogo-kisoku.md)
