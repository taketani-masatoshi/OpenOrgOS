...
**PROP-002** · 1棟貸し · 物理3室 · 最大8名  
運用の全体像: [daily-operations-guide.md](daily-operations-guide.md) · 開業準備: [pre-opening-checklist.md](pre-opening-checklist.md) · **法定帳簿:** [statutory-records-catalog.md](statutory-records-catalog.md)
...
| 個人情報告知 | [../../../../compliance/privacy/guest-privacy-notice.md](../../../../compliance/privacy/guest-privacy-notice.md) | CI 時掲示 |
...
| 消防点検記録 | [maintenance/消防点検記録.csv](templates/maintenance/消防点検記録.csv) | 6ヶ月/年次（消防法） |
...
→ **[guest-facing/00-このフォルダについて.md](templates/guest-facing/00-このフォルダについて.md)** 一覧
...
- [ISO 21401](../../../../compliance/iso/ISO-21401/00-このフォルダについて.md)
