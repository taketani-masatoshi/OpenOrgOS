...
| 消費税 | 課税事業者（本則） · 課税ドラフト要確認 · `docs/finance/tax/consumption/2025/consumption-tax-draft-return.md` |
...
- `orgos operations tax-consumption draft-return --year 2025` で年次ドラフトを再生成。
