# アクティブコンテキスト — テナント `pilot-ledger-003`
...
- `jp_carbon_neutral_2050` / `jp_carbon_neutral_2050` — `steward/modules/jp_carbon_neutral_2050/` **読まない**
- `jp_women_empowerment` / `jp_women_empowerment` — `steward/modules/jp_women_empowerment/` **読まない**
- `jp_privacy_policy` / `jp_privacy_policy` — `steward/modules/jp_privacy_policy/` **読まない**
