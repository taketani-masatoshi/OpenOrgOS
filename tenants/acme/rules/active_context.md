...
- 物件: `PROP-001`
- docs: `docs/properties/PROP-001-minato/operations/`
- 要約: `docs/reports/agent-summaries/rental/`
...
- `REG-016` 内部監査規程 — `docs/company/regulations/naibu-kansa-kisoku.md` · テンプレ **読まない**（regulations.yaml で無効）
- `REG-012` 宿泊運営・サステナビリティ規程 — `docs/company/regulations/shukuhaku-unyo-kisoku.md` · テンプレ **読まない**（regulations.yaml で無効）
