...
| Dead letter audit | `src/lib/protocol/transport/wire-dead-letter-audit.ts` |
...
**OrgOS paths:** `src/lib/protocol/transport/delivery-ledger.ts` · `wire-dead-letter-audit.ts` · `docs/company/events/`
