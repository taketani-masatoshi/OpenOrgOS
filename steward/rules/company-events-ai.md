...
- 月フォルダ: `YYYY-MM`
- 台帳: `data/company-events.yaml`（chain から materialize する派生ビュー）
- チェーン: `data/company-events-chain.jsonl`（**正本** · create/status/void/wire）
...
npm run orgos -- events chain materialize
```
