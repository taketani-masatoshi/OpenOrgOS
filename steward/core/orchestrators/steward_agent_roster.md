...
| id | 特性 | 報告線 | 人間承認 |
|----|------|--------|---------|
| **investor_relations** | 自社 IR · cap table · 開示カレンダー · **未公開情報厳禁** | executive_steward | 開示 · 説明会 |
...
| `compliance` | core | operational | tenant | coo | [compliance_agent.md](compliance_agent.md) |
| `contract` | core | operational | tenant | coo | [contract_agent.md](contract_agent.md) |
| `executive_steward` | core | operational | tenant | — | [executive_steward_agent.md](executive_steward_agent.md) |
| `finance` | core | operational | tenant | coo | [finance_agent.md](finance_agent.md) |
| `operations` | core | operational | tenant | coo | [operations_agent.md](operations_agent.md) |
| `secretary` | core | operational | tenant | coo | [secretary_agent.md](secretary_agent.md) |
| `setup` | core | operational | tenant | — | [setup_agent.md](setup_agent.md) |
| `accounting` | extension | operational | tenant | finance | [accounting_agent.md](accounting_agent.md) |
| `coo` | extension | operational | tenant | executive_steward | [coo_agent.md](coo_agent.md) |
| `corporate_development` | extension | operational | tenant | executive_steward | [corporate_development_agent.md](corporate_development_agent.md) |
| `corporate_governance` | extension | operational | tenant | executive_steward | [corporate_governance_agent.md](corporate_governance_agent.md) |
| `cto` | extension | operational | tenant | coo | [cto_agent.md](cto_agent.md) |
| `customer_success` | extension | operational | tenant | coo | [customer_success_agent.md](customer_success_agent.md) |
| `customer_support` | extension | operational | tenant | customer_success | [customer_support_agent.md](customer_support_agent.md) |
| `data_analytics` | extension | operational | tenant | executive_steward | [data_analytics_agent.md](data_analytics_agent.md) |
| `design` | extension | operational | tenant | design_lead | [design_agent.md](design_agent.md) |
| `design_lead` | extension | operational | tenant | cto | [design_lead_agent.md](design_lead_agent.md) |
| `devops` | extension | operational | tenant | cto | [devops_agent.md](devops_agent.md) |
| `engineering` | extension | operational | tenant | cto | [engineering_agent.md](engineering_agent.md) |
| `esg_sustainability` | extension | operational | tenant | compliance | [esg_sustainability_agent.md](esg_sustainability_agent.md) |
...
| `learning_development` | extension | operational | tenant | human_resources | [learning_development_agent.md](learning_development_agent.md) |
| `legal` | extension | operational | tenant | executive_steward | [legal_agent.md](legal_agent.md) |
| `mail_intake` | extension | operational | tenant | secretary | [mail_intake_agent.md](mail_intake_agent.md) |
| `mail_outbound` | extension | operational | tenant | secretary | [mail_outbound_agent.md](mail_outbound_agent.md) |
| `marketing_lead` | extension | operational | tenant | coo | [marketing_lead_agent.md](marketing_lead_agent.md) |
| `medical_device_regulatory` | extension | operational | tenant | compliance | [medical_device_regulatory_agent.md](medical_device_regulatory_agent.md) |
| `personal_finance` | extension | operational | tenant | executive_steward | [personal_finance_agent.md](personal_finance_agent.md) |
| `pr_communications` | extension | operational | tenant | marketing_lead | [pr_communications_agent.md](pr_communications_agent.md) |
| `privacy_officer` | extension | operational | tenant | compliance | [privacy_officer_agent.md](privacy_officer_agent.md) |
| `procurement` | extension | operational | tenant | coo | [procurement_agent.md](procurement_agent.md) |
| `product_management` | extension | operational | tenant | cto | [product_management_agent.md](product_management_agent.md) |
| `project_management` | extension | operational | tenant | coo | [project_management_agent.md](project_management_agent.md) |
| `quality_assurance` | extension | operational | tenant | coo | [quality_assurance_agent.md](quality_assurance_agent.md) |
| `records_audit` | extension | operational | tenant | executive_steward | [records_audit_agent.md](records_audit_agent.md) |
| `recruiting` | extension | operational | tenant | human_resources | [recruiting_agent.md](recruiting_agent.md) |
| `risk_insurance` | extension | operational | tenant | executive_steward | [risk_insurance_agent.md](risk_insurance_agent.md) |
| `sales_inbound` | extension | operational | tenant | sales_lead | [sales_inbound_agent.md](sales_inbound_agent.md) |
| `sales_lead` | extension | operational | tenant | coo | [sales_lead_agent.md](sales_lead_agent.md) |
| `sales_outbound` | extension | operational | tenant | sales_lead | [sales_outbound_agent.md](sales_outbound_agent.md) |
| `security` | extension | operational | tenant | executive_steward | [security_agent.md](security_agent.md) |
| `social_media` | extension | operational | tenant | marketing_lead | [social_media_agent.md](social_media_agent.md) |
| `tax` | extension | operational | tenant | finance | [tax_agent.md](tax_agent.md) |
| `treasury` | extension | operational | tenant | finance | [treasury_agent.md](treasury_agent.md) |
...
| skills (registry) | 219 | `steward/core/skills/registry.yaml` + modules |
| runtime: cli | 173 | registry |
| runtime: agent | 46 | registry（旧 cursor-only 含む） |
