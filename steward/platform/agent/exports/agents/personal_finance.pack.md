# OrgOS Agent Pack · personal_finance

> **Tool-neutral** — Claude Projects · ChatGPT · Cline · Aider · Continue · Open WebUI 等に貼付 / 添付
> **Generated:** 2026-07-11 · **Tenant:** mal
> **Regenerate:** `orgos operator export --agent personal_finance`
...
- `personal_budget_review` · agent · `steward/core/skills/extension/personal_budget_review.md`
- `personal_expense_categorize` · agent · `steward/core/skills/extension/personal_expense_categorize.md`
