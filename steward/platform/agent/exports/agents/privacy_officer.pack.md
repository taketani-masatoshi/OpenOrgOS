...
## 2. Agent · Privacy Officer（個情管理責任者）
...
- `privacy_impact_review` · cli · `steward/core/skills/extension/privacy_impact_review.md`
- `privacy_data_inventory` · cli · `steward/core/skills/extension/privacy_data_inventory.md`
