# OrgOS Agent Pack · corporate_development

> **Tool-neutral** — Claude Projects · ChatGPT · Cline · Aider · Continue · Open WebUI 等に貼付 / 添付
> **Generated:** 2026-07-11 · **Tenant:** mal
> **Regenerate:** `orgos operator export --agent corporate_development`
...
- `corpdev_ma_screen` · agent · `steward/core/skills/extension/corpdev_ma_screen.md`
- `corpdev_partnership_brief` · agent · `steward/core/skills/extension/corpdev_partnership_brief.md`
