# OrgOS Agent Pack · esg_sustainability

> **Tool-neutral** — Claude Projects · ChatGPT · Cline · Aider · Continue · Open WebUI 等に貼付 / 添付
> **Generated:** 2026-07-11 · **Tenant:** mal
> **Regenerate:** `orgos operator export --agent esg_sustainability`
...
- `esg_metrics_review` · agent · `steward/core/skills/extension/esg_metrics_review.md`
- `esg_report_prep` · agent · `steward/core/skills/extension/esg_report_prep.md`
