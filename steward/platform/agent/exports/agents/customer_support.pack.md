# OrgOS Agent Pack · customer_support

> **Tool-neutral** — Claude Projects · ChatGPT · Cline · Aider · Continue · Open WebUI 等に貼付 / 添付
> **Generated:** 2026-07-11 · **Tenant:** mal
> **Regenerate:** `orgos operator export --agent customer_support`
...
- `support_ticket_triage` · agent · `steward/core/skills/extension/support_ticket_triage.md`
- `support_sla_check` · agent · `steward/core/skills/extension/support_sla_check.md`
