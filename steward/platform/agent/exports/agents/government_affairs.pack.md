# OrgOS Agent Pack · government_affairs

> **Tool-neutral** — Claude Projects · ChatGPT · Cline · Aider · Continue · Open WebUI 等に貼付 / 添付
> **Generated:** 2026-07-11 · **Tenant:** mal
> **Regenerate:** `orgos operator export --agent government_affairs`
...
## 2. Agent · Government Affairs（行政・公的制度）
...
- `gov_subsidy_eligibility` · cli · `steward/core/skills/extension/gov_subsidy_eligibility.md`
- `gov_regulatory_watch` · agent · `steward/core/skills/extension/gov_regulatory_watch.md`
