# OrgOS Agent Pack · devops

> **Tool-neutral** — Claude Projects · ChatGPT · Cline · Aider · Continue · Open WebUI 等に貼付 / 添付
> **Generated:** 2026-07-11 · **Tenant:** mal
> **Regenerate:** `orgos operator export --agent devops`
...
- `devops_infra_health` · agent · `steward/core/skills/extension/devops_infra_health.md`
- `devops_deploy_checklist` · agent · `steward/core/skills/extension/devops_deploy_checklist.md`
