# OrgOS Agent Pack · pr_communications

> **Tool-neutral** — Claude Projects · ChatGPT · Cline · Aider · Continue · Open WebUI 等に貼付 / 添付
> **Generated:** 2026-07-11 · **Tenant:** mal
> **Regenerate:** `orgos operator export --agent pr_communications`
...
- `pr_press_release_draft` · agent · `steward/core/skills/extension/pr_press_release_draft.md`
- `pr_media_monitoring` · agent · `steward/core/skills/extension/pr_media_monitoring.md`
