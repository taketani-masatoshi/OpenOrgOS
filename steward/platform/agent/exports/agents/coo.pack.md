# OrgOS Agent Pack · coo

> **Tool-neutral** — Claude Projects · ChatGPT · Cline · Aider · Continue · Open WebUI 等に貼付 / 添付
> **Generated:** 2026-07-11 · **Tenant:** mal
> **Regenerate:** `orgos operator export --agent coo`
...
- `coo_work_order_triage` · cli · `steward/core/skills/extension/coo_work_order_triage.md`
- `coo_routing_review` · cli · `steward/core/skills/extension/coo_routing_review.md`
