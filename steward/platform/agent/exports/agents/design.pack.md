# OrgOS Agent Pack · design

> **Tool-neutral** — Claude Projects · ChatGPT · Cline · Aider · Continue · Open WebUI 等に貼付 / 添付
> **Generated:** 2026-07-11 · **Tenant:** mal
> **Regenerate:** `orgos operator export --agent design`
...
- `design_asset_inventory` · agent · `steward/core/skills/extension/design_asset_inventory.md`
- `design_ui_spec_draft` · agent · `steward/core/skills/extension/design_ui_spec_draft.md`
