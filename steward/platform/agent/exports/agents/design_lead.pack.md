# OrgOS Agent Pack · design_lead

> **Tool-neutral** — Claude Projects · ChatGPT · Cline · Aider · Continue · Open WebUI 等に貼付 / 添付
> **Generated:** 2026-07-11 · **Tenant:** mal
> **Regenerate:** `orgos operator export --agent design_lead`
...
- `design_lead_review` · agent · `steward/core/skills/extension/design_lead_review.md`
- `design_system_audit` · agent · `steward/core/skills/extension/design_system_audit.md`
