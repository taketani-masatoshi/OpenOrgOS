# OrgOS Agent Pack · product_management

> **Tool-neutral** — Claude Projects · ChatGPT · Cline · Aider · Continue · Open WebUI 等に貼付 / 添付
> **Generated:** 2026-07-11 · **Tenant:** mal
> **Regenerate:** `orgos operator export --agent product_management`
...
## 2. Agent · Product Management（プロダクト）
...
- `pm_roadmap_review` · agent · `steward/core/skills/extension/pm_roadmap_review.md`
- `pm_feature_prioritization` · agent · `steward/core/skills/extension/pm_feature_prioritization.md`
