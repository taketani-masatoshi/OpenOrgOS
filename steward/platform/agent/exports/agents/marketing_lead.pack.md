# OrgOS Agent Pack · marketing_lead

> **Tool-neutral** — Claude Projects · ChatGPT · Cline · Aider · Continue · Open WebUI 等に貼付 / 添付
> **Generated:** 2026-07-11 · **Tenant:** mal
> **Regenerate:** `orgos operator export --agent marketing_lead`
...
## 2. Agent · Marketing Lead（マーケティング統括）
...
- `marketing_content_calendar` · agent · `steward/core/skills/extension/marketing_content_calendar.md`
- `marketing_campaign_brief` · agent · `steward/core/skills/extension/marketing_campaign_brief.md`
