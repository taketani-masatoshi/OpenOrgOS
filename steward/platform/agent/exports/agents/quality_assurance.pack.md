# OrgOS Agent Pack · quality_assurance

> **Tool-neutral** — Claude Projects · ChatGPT · Cline · Aider · Continue · Open WebUI 等に貼付 / 添付
> **Generated:** 2026-07-11 · **Tenant:** mal
> **Regenerate:** `orgos operator export --agent quality_assurance`
...
- `qa_nonconformance_triage` · cli · `steward/core/skills/extension/qa_nonconformance_triage.md`
- `qa_iso9001_controls` · agent · `steward/core/skills/extension/qa_iso9001_controls.md`
