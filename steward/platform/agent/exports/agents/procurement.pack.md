...
- `procurement_order_review` · agent · `steward/core/skills/extension/procurement_order_review.md`
- `procurement_vendor_eval` · agent · `steward/core/skills/extension/procurement_vendor_eval.md`
