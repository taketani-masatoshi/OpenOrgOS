# OrgOS Agent Pack · recruiting

> **Tool-neutral** — Claude Projects · ChatGPT · Cline · Aider · Continue · Open WebUI 等に貼付 / 添付
> **Generated:** 2026-07-11 · **Tenant:** mal
> **Regenerate:** `orgos operator export --agent recruiting`
...
- `recruiting_pipeline_review` · agent · `steward/core/skills/extension/recruiting_pipeline_review.md`
- `recruiting_interview_prep` · agent · `steward/core/skills/extension/recruiting_interview_prep.md`
