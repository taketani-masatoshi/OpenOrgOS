# OrgOS Agent Pack · intellectual_property

> **Tool-neutral** — Claude Projects · ChatGPT · Cline · Aider · Continue · Open WebUI 等に貼付 / 添付
> **Generated:** 2026-07-11 · **Tenant:** mal
> **Regenerate:** `orgos operator export --agent intellectual_property`
...
## 2. Agent · Intellectual Property（知財）
...
- `ip_portfolio_review` · cli · `steward/core/skills/extension/ip_portfolio_review.md`
- `ip_trademark_status` · agent · `steward/core/skills/extension/ip_trademark_status.md`
