...
- `governance_meeting_prep` · agent · `steward/core/skills/extension/governance_meeting_prep.md`
- `governance_register_review` · agent · `steward/core/skills/extension/governance_register_review.md`
