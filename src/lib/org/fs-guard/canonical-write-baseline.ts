...
export const CANONICAL_WRITE_BASELINE: CanonicalWriteBaselineEntry[] = [
  ...
  { file: "src/lib/finance/filing/official-receipt.ts", symbol: "writeFileSync", count: 1, note: "human-attested official filing receipt YAML under data/finance/filing/" },
  ...
  { file: "src/lib/finance/acceptance/bookkeeping-acceptance.ts", symbol: "writeFileSync", count: 1, note: "disposable bookkeeping acceptance evidence in the test workspace, not a tenant canonical file" },
  ...
  { file: "src/lib/finance/acceptance/sole-prop-lane-f-acceptance.ts", symbol: "writeFileSync", count: 8, note: "disposable sole-prop acceptance fixtures in the test workspace, not a tenant canonical file" },
