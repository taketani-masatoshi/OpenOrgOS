...
export const CANONICAL_WRITE_BASELINE: CanonicalWriteBaselineEntry[] = [
  ...
  { file: "src/commands/skills.ts", symbol: "writeFileSync", count: 1, note: "os.tmpdir workflow draft.json, not a tenant canonical file" },
  ...
  { file: "src/lib/finance/payroll-bonus-yea.ts", symbol: "writeFileSync", count: 5, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/product/stripe-webhook.ts", symbol: "renameSync", count: 1, note: "atomic replace of product-fleet welcome-pending runtime file" },
  { file: "src/lib/product/stripe-webhook.ts", symbol: "writeFileSync", count: 2, note: "product-fleet welcome-pending runtime files, not tenant YAML" },
  { file: "src/lib/protocol/core/audit-chain.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/protocol/adapters/community-export.ts", symbol: "copyFileSync", count: 3, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/protocol/adapters/community-export.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/protocol/adapters/community-gmail-bind.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/protocol/adapters/community-integration-flags.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/protocol/transport/dev-server-tls.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/protocol/transport/transport.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/protocol/distribution/trusted-hubs-sync.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/protocol/readiness/wire-live-verify.ts", symbol: "copyFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/protocol/readiness/wire-live-verify.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/protocol/distribution/wire-trust-registry-sync.ts", symbol: "writeFileSync", count: 2, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/protocol/distribution/witness-attestation-build.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/protocol/distribution/witness-trust.ts", symbol: "writeFileSync", count: 4, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/steward-chat/routes/esign-api.ts", symbol: "writeFileSync", count: 2, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
