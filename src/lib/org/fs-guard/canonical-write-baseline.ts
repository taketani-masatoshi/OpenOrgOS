...
export const CANONICAL_WRITE_BASELINE: CanonicalWriteBaselineEntry[] = [
  { file: "src/commands/etax.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/commands/hr.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/commands/iso-scaffold.ts", symbol: "writeFileSync", count: 2, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/commands/skills.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/canvas-views/sync-view.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/correspondence/gmail-receive-sync.ts", symbol: "writeFileSync", count: 2, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/correspondence/gmail-thread-fetch.ts", symbol: "writeFileSync", count: 2, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/etax/cab-unpack.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/etax/host-bind.ts", symbol: "writeFileSync", count: 3, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/etax/production-release.ts", symbol: "writeFileSync", count: 2, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/etax/spec-fetch.ts", symbol: "writeFileSync", count: 3, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/etax/store.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/etax/transmission-evidence-io.ts", symbol: "writeFileSync", count: 8, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/etax/xml-validate.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/finance/finance-mutation-lock.ts", symbol: "renameSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/finance/ledger/companies-act-score.ts", symbol: "writeFileSync", count: 2, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/finance/ledger/journal-export.ts", symbol: "writeFileSync", count: 2, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/finance/reconciliation-recovery-audit.ts", symbol: "renameSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/finance/reconciliation-recovery-audit.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/finance/reconciliation-transaction.ts", symbol: "renameSync", count: 4, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/integrations/connector-store.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/iso-templates.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/operator-change/plan.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/org/governance-principles.ts", symbol: "writeFileSync", count: 11, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/pdf-esign/case-workflow.ts", symbol: "writeFileSync", count: 2, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/product/ledger-bookkeeping-acceptance.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/product/ledger-coa-ensure.ts", symbol: "writeFileSync", count: 3, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/product/ledger-guest-invite.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/product/ledger-legal-attestation.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/product/ledger-mail.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/product/ledger-proposal-queue.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/product/ledger-provision.ts", symbol: "writeFileSync", count: 6, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/product/ledger-restore-drills.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/product/ledger-sole-prop-lane-f-acceptance.ts", symbol: "writeFileSync", count: 7, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/product/ledger-stripe-webhook-idempotency.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/product/ledger-tenant-export.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/product/ledger-tenant-restore.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/product/stripe-ops.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/product/stripe-webhook.ts", symbol: "renameSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/product/stripe-webhook.ts", symbol: "writeFileSync", count: 2, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/protocol/community-integration-flags.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/receipt-qr/config.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/receipt-qr/issue.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/receipt-qr/payload-store.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/receipt-qr/registry.ts", symbol: "renameSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/receipt-qr/registry.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/regulation-draft-scaffold.ts", symbol: "writeFileSync", count: 3, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/secrets/env-file-store.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/steward-chat/answer-memory.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/steward-chat/faq-index.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  ...
  { file: "src/lib/tax/tax-handoff-package.ts", symbol: "writeFileSync", count: 5, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
