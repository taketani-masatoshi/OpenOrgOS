...
export const CANONICAL_WRITE_BASELINE: CanonicalWriteBaselineEntry[] = [
  ...
  { file: "src/lib/compliance/iso/templates.ts", symbol: "writeFileSync", count: 1, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/compliance/regulations/seed.ts", symbol: "writeFileSync", count: 2, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
