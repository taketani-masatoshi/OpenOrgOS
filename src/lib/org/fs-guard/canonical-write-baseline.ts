...
export const CANONICAL_WRITE_BASELINE: CanonicalWriteBaselineEntry[] = [
  ...
  { file: "src/lib/finance/etax.ts", symbol: "writeFileSync", count: 7, note: "e-Tax runtime XML, sealed send copies, audit chain, state, signature and receipt evidence in configured encrypted storage, not tenant YAML" },
  ...
  { file: "src/lib/tax/tax-handoff-package.ts", symbol: "writeFileSync", count: 7, note: "advisor handoff package artifacts; existing branch additions synchronized with direct-write inventory" },
