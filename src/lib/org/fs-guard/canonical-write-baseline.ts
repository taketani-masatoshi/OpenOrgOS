...
export const CANONICAL_WRITE_BASELINE: CanonicalWriteBaselineEntry[] = [
  ...
  { file: "src/lib/product/ledger-provision.ts", symbol: "cpSync", count: 3, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
  { file: "src/lib/product/ledger-provision.ts", symbol: "writeFileSync", count: 3, note: "pending migration to wrapCanonicalWrite / writeYamlFile / writeTrackedFile" },
