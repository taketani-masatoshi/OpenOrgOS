...
export const CANONICAL_WRITE_BASELINE: CanonicalWriteBaselineEntry[] = [
  ...
  { file: "src/lib/product/ledger-sole-prop-lane-f-acceptance.ts", symbol: "writeFileSync", count: 8, note: "disposable sole-prop acceptance fixtures in the test workspace, not a tenant canonical file" },
