...
export const PROTOCOL_FILE_LAYER: Readonly<Record<string, ProtocolLayer>> = {
  ...
  "src/lib/protocol/core/envelope-lookup.ts": "core",
  ...
  "src/lib/protocol/transport/email-wire-port.ts": "transport",
  ...
  "src/lib/protocol/distribution/notice-transmit.ts": "distribution",
  "src/lib/protocol/distribution/org-cert-witness.ts": "distribution",
  "src/lib/protocol/distribution/peer-discovery.ts": "distribution",
  ...
  "src/lib/protocol/distribution/resilience-sla.ts": "distribution",
  "src/lib/protocol/distribution/transaction-orphans.ts": "distribution",
  ...
  "src/lib/protocol/adapters/protocol-api-server.ts": "adapters",
