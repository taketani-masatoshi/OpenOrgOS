...
import { appendProtocolAuditRecord, writeOutboxEnvelope } from "../core/audit-chain.js";
import { runWithProtocolWriteGuard } from "../core/protocol-write-guard.js";
import { ourOrgRef } from "../core/identity.js";
import { getProtocolOutboxDir } from "../core/paths.js";
import { validateEnvelopeAgainstRegistry } from "./registry.js";
import { maybeSignEnvelope } from "../core/signing.js";
