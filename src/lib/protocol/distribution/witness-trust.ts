...
export async function fetchWitnessTrustBundle(
  ...
  const { loadProtocolApiClientConfig, mergeTlsCredentials } = await import("../transport/protocol-api-config.js");
  const { protocolFetch } = await import("../transport/protocol-tls.js");
