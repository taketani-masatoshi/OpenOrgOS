...
import { ensureProtocolSigningKey, exportProtocolPublicKeyBase64 } from "../core/signing.js";
...
export interface SubmitWireNodeRequestOptions {
  tenantId: string;
  /** Caller-loaded wire-gateway.yaml — keeps distribution free of wire-gateway imports. */
  gateway: WireGatewayConfig;
  wireEmail?: string;
