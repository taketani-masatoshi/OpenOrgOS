...
export const PROTOCOL_LAYER_VIOLATION_BASELINE: readonly string[] = [
  ...
  "src/lib/protocol/transport/notice-transmit.ts (transport) -> src/lib/protocol/distribution/contract-witness-pool.ts (distribution)",
  "src/lib/protocol/transport/notice-transmit.ts (transport) -> src/lib/protocol/distribution/witness-hook.ts (distribution)",
  "src/lib/protocol/transport/notice-transmit.ts (transport) -> src/lib/protocol/distribution/witness-policy.ts (distribution)",
  ...
  "src/lib/protocol/transport/relay.ts (transport) -> src/lib/protocol/distribution/wire-relay-store.ts (distribution)",
  "src/lib/protocol/transport/resilience-sla.ts (transport) -> src/lib/protocol/distribution/witness-client.ts (distribution)",
  "src/lib/protocol/transport/resilience-sla.ts (transport) -> src/lib/protocol/distribution/witness-pool.ts (distribution)",
  "src/lib/protocol/transport/resilience-sla.ts (transport) -> src/lib/protocol/distribution/witness-queue.ts (distribution)",
  "src/lib/protocol/transport/transaction-orphans.ts (transport) -> src/lib/protocol/distribution/witness-client.ts (distribution)",
  "src/lib/protocol/transport/transaction-orphans.ts (transport) -> src/lib/protocol/distribution/witness-pool.ts (distribution)",
  "src/lib/protocol/transport/transaction-orphans.ts (transport) -> src/lib/protocol/distribution/witness-queue.ts (distribution)",
  "src/lib/protocol/transport/transport.ts (transport) -> src/lib/protocol/adapters/email-wire-deliver.ts (adapters)",
  "src/lib/protocol/transport/transport.ts (transport) -> src/lib/protocol/distribution/witness-client.ts (distribution)",
] as const;
