...
import { writeAgentSummaries, formatAgentSummariesSection } from "../lib/agent-summaries.js";
...
export function runDashboard(options: DashboardOptions = {}): void {
  ...
  if (options.markdown !== false) {
    ...
    console.log(
      `✓ Agent 要約 7 件 + 拡張 ${extensionPulses.length} 件: docs/reports/agent-summaries/ · executive-notes/`
    );
  }
