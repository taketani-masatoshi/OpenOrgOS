...
**Status:** not executed · Phase 7 scaffolding only
...
4. Record request id, dates, procedure codes, and evidence under gitignored `tenants/*/data/etax/transmission-test/` and set `production-gate.yaml` `nta_transmission_test.evidence_path`.
