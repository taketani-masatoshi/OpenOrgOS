...
**ステータス:** 料金案（招待制・契約ベース提供） · 税別 · 変更時は版を上げて通知する

セルフチェックアウトは未開放です。Stripe live キーと本番 webhook の確認が完了するまで、価格表は見積・契約検討用の案として扱います。現在の提供境界は [commercial-claim-checklist.md](commercial-claim-checklist.md) と一致させます。
