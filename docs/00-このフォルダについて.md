...
| 見たいもの | ファイル |
|-----------|---------|
| **4 層アーキテクチャ** | [13_rules/steward_os_principles.md](../13_rules/steward_os_principles.md) · [11_agents/](../11_agents/00-このフォルダについて.md)（**8 Agent**）· [12_skills/](../12_skills/) |
| **Agent 要約（Steward 読取）** | [reports/agent-summaries/](reports/agent-summaries/) |
| **詳細パス索引（レガシー）** | [agent_architecture.md](agent_architecture.md) |
