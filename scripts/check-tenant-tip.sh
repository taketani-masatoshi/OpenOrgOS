...
# This is Core tip hygiene — not a substitute for the umbrella forbid-tenant-github-post.sh.
set -euo pipefail
...
# Allowed ids match docs/org-os/tenant-github-tip-policy.md (do not blanket-reject demos).
...
# 4. Sensitive finance ledgers outside template / fixture / allowed demo tenants.
